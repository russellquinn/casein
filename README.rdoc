...
** ALL-NEW CASEIN 5.0.0 — featuring new responsive UI based on Bootstrap 3.3! **
...
Casein is using Bootstrap 3.3.1 Sass distribution included via the Twitter (bootstrap-sass)[http://github.com/twbs/bootstrap-sass] gem.  If you want to use this in your main app, you can add the following lines to your +application.css.scss+ file and you'll have bootstrap at your fingertips.

  @import 'bootstrap-sprockets';
  @import 'bootstrap';

You should not have to include +bootstrap-sass+ in your application's Gemfile as it'll come through via Casein.

NOTE: You must be using Sass and your +application.css+ file must be called +application.css.scss+ for these to be properly imported by Sprockets.
