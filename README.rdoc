...
===== Using custom form elements from external libraries

You can also use custom form elements from other libraries.
If you have to include javascripts for this element, you have to add it to app/assets/javascripts/casein/custom.js (and not to app/assets/javascripts/application.js)

E.g. if you want to you use ckeditor for a RichText-field, you have to add the line
  //= require ckeditor/init
to app/assets/javascripts/casein/custom.js
