...
In order to test the Casein-forms you have to create an admin user:
  email = "user@example.com"
  name = "casein_user"
  password = "please12"
  user = Casein::AdminUser.create! email: email, login: name, name: name, password: password, password_confirmation: password, access_level: 0

And log in with it.
For example with Capybara:
